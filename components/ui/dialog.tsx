...
>(({ className, ...props }, ref) => {
  ...
  return (
    <DialogPrimitive.Overlay
      className={cn(
        "bg-black/60 text-white flex justify-center items-center p-2 absolute top-0 right-0 bottom-0 left-0 mt-4 rounded",
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("text-sm text-white native:text-base", className)}
    {...props}
  />
));
