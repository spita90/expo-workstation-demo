...
export const BottomBar = () => {
  ...
  const drierFilterRemainingPercentage = 50;
  ...
  return (
    <View className="flex flex-row h-20 justify-between items-center px-4">
      ...
      <View className="flex flex-row gap-4 items-center">
        <Bars
          id="filter"
          barQty={Math.ceil(drierFilterRemainingPercentage / 10)}
          fillMode="rtl"
          colored
        />
        <Text className="w-14 text-center font-agdasima text-2xl">{`${drierFilterRemainingPercentage}%`}</Text>
        {/* filter */}
        <svg
          width="58"
          height="59"
        ...
        >
          ...
          <path
            ...
            fill={
              drierFilterRemainingPercentage <= ICON_RED_THRESHOLD
                ? "red"
                : drierFilterRemainingPercentage <= ICON_YELLOW_THRESHOLD
                ? "yellow"
                : "white"
            }
          />
          <path
            ...
            fill="white"
            fillOpacity={drierFilterRemainingPercentage <= 20 ? "0.6" : "0.2"}
            stroke={
              drierFilterRemainingPercentage <= ICON_RED_THRESHOLD
                ? "red"
                : drierFilterRemainingPercentage <= ICON_YELLOW_THRESHOLD
