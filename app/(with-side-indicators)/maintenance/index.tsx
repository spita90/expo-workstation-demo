...
const warningModalCaptions = {
  actuatorPressButRunningProcedure:
    "operations.maintenance_.advancedSupport_.testIo_.actuatorPressButRunningProcedure",
  testRunPressButActiveActuators:
    "operations.maintenance_.advancedSupport_.testIo_.testRunPressButActiveActuators",
};
            ...
            {!runningTestRunCode && (
              ...
              >
                ...
                {!testRunModalOpen && (
                  <Text>
                    {t(
                      "operations.maintenance_.advancedSupport_.testIo_.testRun"
                    )}
                  </Text>
                )}
